...
public class appMenu {
	...
	// 계정추가 (회원가입완료)
	private Account addAccount(String id, String pw, String name, String idNum, char gender, String pNum, String bank,
			int coupon) {
		return new Account();
	}
